...
magento_admin_orders:
	vendor/bin/paratest -p 1 -f --phpunit=vendor/bin/phpunit tests/Magento_Admin_Orders.php

m1_checkout:
	vendor/bin/paratest -p 1 -f --phpunit=vendor/bin/phpunit tests/M1_Checkout.php
